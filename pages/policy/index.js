...
export default function index() {
  return (
    <div>
      <di class="background background--light background--dark">
        <h2 className=" text-center text-white mb-12 mt-6">Privacy Policy</h2>
        <p className="text-white">
          Thank you for choosing to be part of our community at degolib.
          ...
          to your personal information, please contact us at info@degolib.xyz.
          When you visit our website www.degolib.xyz, mobile application, and
          ...
          or Apps and our services. This privacy policy applies to all
          information collected through our website (such as www.degolib.xyz),
